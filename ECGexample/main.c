...
int main()
{
    ...
    calc_sig_dft((double *)&_640_points_ecg_,(double *)&Output_REX,(double *)&Output_IMX, SIG_LENGTH);
    get_dft_output_mag((double *)&Output_MAG);
    sig_calc_idft((double *)&Output_IDFT, (double *)&Output_REX,(double *)&Output_IMX,SIG_LENGTH);
